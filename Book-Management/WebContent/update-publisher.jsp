                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                     <form class="user" action="UpdatePublisherController" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="pIC"
                                        placeholder="Publisher IC" value="<c:out value="${publisher.pIC}"/>" required/>
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" name="uIC"
                                        placeholder="User IC" value="<c:out value="${publisher.uIC}"/>" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="pName"
                                        placeholder="Publisher Name" value="<c:out value="${publisher.pName}"/>" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="pCity"
                                        placeholder="City" value="<c:out value="${publisher.pCity}"/>" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="pState"
                                        placeholder="State" value="<c:out value="${publisher.pState}"/>" required>
                                </div>
