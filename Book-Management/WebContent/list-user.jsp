                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">View Publisher</h6>
                                </div>
                                <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <c:forEach items="${user}" var="user" begin="0" varStatus="count">
                                        <tr>
                                        <td><c:out value="${count.count}"/></td>
                                        <td><c:out value="${user.uIC}"/></td>
							            <td><c:out value="${user.uName}" /></td>
							            <td><c:out value="${user.uEmail}" /></td>
							             <td><a href="UpdateUserController?action=update&uIC=<c:out
            value="${user.uIC}" />" class="w3-btn w3-green w3-round-large" >Update</a></td>
              <td><a href="DeleteUserController?action=delete&uIC=<c:out
            value="${user.uIC}" />" class="w3-btn w3-red w3-round-large" onclick="ConfirmDelete()">Delete</a></td>
                                        </tr>
                                        </c:forEach>
