                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                     <form class="user" action="UpdateAuthorController" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="aIC"
                                        placeholder="Author IC" value="<c:out value="${author.aIC}"/>" required/>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="uIC"
                                        placeholder="User IC" value="<c:out value="${author.uIC}"/>" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="aName"
                                        placeholder="Author Name" value="<c:out value="${author.aName}"/>" required>
                                </div>
                                <div class="form-group">
                                    <input type="date" class="form-control form-control-user" name="aDOB"
                                        placeholder="Author Birth of Date" value="<c:out value="${author.aDOB}"/>" required>
                                </div>
                                <div class="form-group">
