                        ...
                        <div class="col mb-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <c:forEach items="${author}" var="author" begin="0" varStatus="count">
                                        <tr>
                                        <td><c:out value="${count.count}"/></td>
                                        <td><c:out value="${author.aIC}" /></td>
                                
							            <td><c:out value="${author.aName}" /></td>
							            <td><c:out value="${author.aGender}" /></td>
							            <td><c:out value="${author.aDOB}" /></td>
							             <td><c:out value="${author.uIC}" /></td>
							             <td><a href="UpdateAuthorController?action=update&aIC=<c:out
            value="${author.aIC}" />" class="w3-btn w3-green w3-round-large" >Update</a></td>
              <td><a href="DeleteAuthorController?action=delete&aIC=<c:out
            value="${author.aIC}" />" class="w3-btn w3-red w3-round-large" onclick="ConfirmDelete()">Delete</a></td>
                                        </tr>
                                        </c:forEach>
