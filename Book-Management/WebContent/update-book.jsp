                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                     <form class="user" action="UpdateBookController" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="isbn"
                                        placeholder="ISBN" value="<c:out value="${book.isbn}"/>" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="uIC"
                                        placeholder="User IC" value="<c:out value="${book.uIC}"/>" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="pIC"
                                        placeholder="Publisher IC" value="<c:out value="${book.pIC}"/>" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="bTitle"
                                        placeholder="Book Title" value="<c:out value="${book.bTitle}"/>" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="bEdition"
                                        placeholder="Edition" value="<c:out value="${book.bEdition}"/>" required>
                                </div>
                                <div class="form-group">
                                    <input type="date" class="form-control form-control-user" name="bDate"
                                        placeholder="Date of Publish" value="<c:out value="${book.bDate}"/>" required>
                                </div>
                                 <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="bFiction"
                                        placeholder="Ficiton/Non Fiction" value="<c:out value="${book.bFiction}"/>" required>
                                </div>
                                 <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="bLanguage"
                                        placeholder="Language" value="<c:out value="${book.bLanguage}"/>" required>
                                </div>
                                 <div class="form-group">
