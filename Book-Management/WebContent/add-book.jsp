                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Add Bok</h6>
                                </div>
                                <div class="card-body">
                                     <form class="user" action="AddBookController" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="uIC"
                                       placeholder="<%=uName%>" value="${uIC}" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="pIC"
                                        placeholder="Publisher IC" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="date" class="form-control form-control-user" name="bDate"
                                        placeholder="Date of Publish" required>
                                </div>
                                 <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="bFiction"
                                        placeholder="Ficiton/Non Fiction" required>
                                </div>
                                 <div class="form-group">
