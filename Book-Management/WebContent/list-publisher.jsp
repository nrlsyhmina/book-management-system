                        ...
                        <div class="col mb-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <c:forEach items="${publisher}" var="publisher" begin="0" varStatus="count">
                                        <tr>
                                        <td><c:out value="${count.count}"/></td>
                                        <td><c:out value="${publisher.pIC}"/></td>
							            <td><c:out value="${publisher.pName}" /></td>
							            <td><c:out value="${publisher.pCity}" /></td>
							            <td><c:out value="${publisher.pState}" /></td>
							             <td><c:out value="${publisher.uIC}" /></td>
